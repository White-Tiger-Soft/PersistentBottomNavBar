...
class PersistentBottomNavBar extends StatelessWidget {
  ...
  })  : assert(navBarStyle == null || customStyleBuilder == null),
        super(key: key);
  ...
  PersistentBottomNavBar copyWith(
      ...
      bool? isCustomWidget,
      Widget? Function(NavBarEssentials)? customStyleBuilder,
      EdgeInsets? padding}) {
  ...
  Widget? getNavBarStyle() {
    ...
    } else if (customStyleBuilder != null) {
      return customStyleBuilder!(this.navBarEssentials!);
    } else {
      switch (navBarStyle) {
        ...
        case NavBarStyle.wts_medical:
          return BottomNavStyleWTSMedical(
            navBarEssentials: this.navBarEssentials,
          );
        default:
